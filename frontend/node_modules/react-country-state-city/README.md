...
By default, the control will load the github hosted data files. Alternatively, you can [download the data](https://github.com/venkatvidyut/react-country-state-city/tree/master/data) json file and host it yourself. Simply download the JSON files, and supply the src property to each control to tell it where to download from.

## Documentation

[Read Documentation](https://venkatvidyut.github.io/react-country-state-city-docs/)

## Financial Contributors

Buy me a cup of coffee,

Binance Smart Chain or Ethereum - 0x92aE9323db4483a9de963663DF9E0052A330600f
